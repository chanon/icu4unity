...
cmake -DTARGET_PLATFORM=Android  -G "Unix Makefiles" -DCMAKE_MAKE_PROGRAM="%ANDROID_NDK_ROOT%/prebuilt/windows-x86_64/bin/make.exe" -DCMAKE_BUILD_TYPE=Release -DANDROID_ABI="armeabi-v7a" %proj%
popd
